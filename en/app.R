...
ui <- fluidPage( # Creating shiny app's UI
    ...
    selectInput('person', 'Person/Organization', choices = c(unique(mydata$person_en),"Total"), selected="Total", multiple=FALSE),
...
server <- function(input, output) {
    mytext <- reactive({ # Adding reactive data information
        ...
        # Creating matrix od texts after "cleaning" them from anything unnecessary
